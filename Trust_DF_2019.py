...
if DEBUG:
    ...
    subjDlg.addField('Enter Subject Age: ') #1
    subjDlg.addField('Enter Subject Sex (0 for male, 1 for female): ') #NOTE: PARTNER IS THE CONFEDERATE/STRANGER #2
...
run_data = {
    ...
    'Participant Sex': subj_sex,
    'Date': str(datetime.datetime.now()),
    'Description': 'Trust_ACE'
    }
...
# instruction screen #
instruct_screen = visual.TextStim(win, text='Remember to press the number 2 to send the amount on the lower left of the screen and to press the number 3 to send the amount on the lower right of the screen. ', pos = (0,1), wrapWidth=20, height = 1.2)
...
imgdir = '%s/Images/pos.png' % (expdir)
